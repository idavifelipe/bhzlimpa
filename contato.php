    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <h1 class="my-4" style="color: white;">Contato
          </h1>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="email">
                                    Endere&ccedil;o de E-mail</label>
            ...
            <div class="card my-8" style="margin-top:20px;">
                <div class="card-body">
                    <form>
                        <legend>Nosso escrit&oacute;rio</legend>
                        <address>
                            <strong>BHZ Limpa, Inc.</strong><br>
                            Belo Horizonte, Santa Efig&ecirc;nia<br>
                            Rua Vista Alegre, 656<br>
                            <abbr title="Phone">
                                Tel:</abbr>
                            (31) 99999-9999
                        </address>
                        <address>
                            <strong>BHZ Limpa</strong><br>
                            <a href="mailto:#">contato@bhzlimpa.com</a>
                        </address>
                    </form>
                </div>
            </div>

      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="quem-somos.php">Quem Somos
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <h1 class="my-4" style="color: white;">Quem somos
          </h1>
            ...
            <div class="card my-8">
                <div class="card-body">
                    ...
                    <p> <strong>BHZ Limpa</strong> nasceu no munic&iacute;pio de Floresta, no Sert&atilde;o de Pernambuco, e formou-se em Jornalismo com Habilita&ccedil;&atilde;o em Comunica&ccedil;&atilde;o Social pela Faculdade Joaquim Nabuco (FJN), em Recife, PE.</p>

                    <p> A paix&atilde;o pelo webjornalismo e pelo universo dos blogs surgiu com a constata&ccedil;&atilde;o das possibilidades da internet, a exemplo do car&aacute;ter democr&aacute;tico e agilidade com que a informa&ccedil;&atilde;o pode chegar ao p&uacute;blico.</p>

                    <p>A vontade de tocar um projeto pr&oacute;prio e contribuir com o jornalismo regional, atrav&eacute;s da divulga&ccedil;&atilde;o de conte&uacute;do de qualidade e com responsabilidade, fez nascer o Blog do BHZ Limpa.</p>

                    <p>Assim, &eacute; lan&ccedil;ado em junho de 2015, um ve&iacute;culo disposto a noticiar os fatos relevantes de Floresta-PE e do Sert&atilde;o de Pernambuco. O objetivo do Blog do BHZ Limpa &eacute; levar informa&ccedil;&atilde;o, sem amarras de interesse, e de compromisso firmado com voc&ecirc;, leitor!</p>

                    <strong><p>Seja bem-vindo!</p></strong>

                    <p><a href="contato.php">Clique aqui</a> e entre contato.</p>

                    <p>Quer enviar uma sugest&atilde;o de mat&eacute;ria? Den&uacute;ncia? Fotos e v&iacute;deos? Ent&atilde;o, clique aqui.</p>

                    <p>Deseja saber como anunciar no Blog do BHZ Limpa? Clique aqui e saiba mais!</p>

                    <p>Se voc&ecirc; quer divulgar o seu evento no Blog do BHZ Limpa, ent&atilde;o clique neste link para fazer o cadastro online.</p>

                    <p>Tem um vlog, blog, ou site? <a href="contato.php">Clique aqui</a> e fa&ccedil;a parceria comigo! Gosto de fazer novas amizades!</p>
                </div>
            </div>
